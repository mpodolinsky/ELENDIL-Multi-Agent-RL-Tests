...
def evaluate_checkpointed_models(run_id, run_dir=None, num_episodes=5):
    ...
    for checkpoint_file in checkpoint_files:
        ...
        try:
            # Build command with run_dir if provided
...
if __name__ == "__main__":
    ...
    try:
        ...
        if 'run' in locals():
            ...
            print(f"{'='*70}")
            evaluate_checkpointed_models(run_id, run_dir=original_run_dir, num_episodes=5)
